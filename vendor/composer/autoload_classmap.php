...
return array(
    ...
    'MOB_Inventory_Report' => $baseDir . '/includes/class-inventory-report.php',
    'MOB_PDF_Generator' => $baseDir . '/includes/class-pdf-generator.php',
    'MOB_Profitability_Report' => $baseDir . '/includes/class-profitability-report.php',
    'MOB_Reports_Scheduler' => $baseDir . '/includes/class-scheduler.php',
    'MOB_Reports_Settings' => $baseDir . '/includes/class-settings.php',
    'MOB_Slack_Sender' => $baseDir . '/includes/class-slack-sender.php',
